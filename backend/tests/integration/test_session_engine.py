...
async def test_long_history_window_truncates_and_notes(
    ...
    """Six prior turns of 50k tokens each blow the budget: the model must
    receive only the newest turn(s), plus a system note marking the cut, and
    the oldest content must not be sent.
